...
Profile page and books page require login to access (a login required feature)
Session stays open for debugging (reduce times I (the admin) have to login when I'm programming)
Login keeps email first name and last name fields filled if they are incorrect as page reloads
...
6. Minimum character limit: trigger a fetch only if the user has typed two characters
